...
RUN /go/bin/goversioninfo -64 -icon=assets/genesisit.ico -application-icon=assets/genesisit.ico -manifest=assets/genesisit.exe.manifest \
	  ...
	  -file-version=0.9.75.0 -product-version=0.9.75.0 -product-name=RemoteIt \
      -internal-name=RemoteItAgent -original-name=RemoteIt-Agent-Setup.exe \
	  -ver-major=0 -ver-minor=9 -ver-patch=74 -ver-build=0 \
	  -product-ver-major=0 -product-ver-minor=9 -product-ver-patch=74 -product-ver-build=0 assets/versioninfo.json && \
