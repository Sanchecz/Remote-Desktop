...
-file-version=1.0.12.0 -product-version=1.0.12.0 -product-name=RemoteIt \
      -internal-name=RemoteItAgent -original-name=RemoteIt-Agent-Setup.exe \
	  -ver-major=1 -ver-minor=0 -ver-patch=12 -ver-build=0 \
	  -product-ver-major=1 -product-ver-minor=0 -product-ver-patch=12 -product-ver-build=0 assets/versioninfo.json && \
