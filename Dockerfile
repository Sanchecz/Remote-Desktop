...
RUN /go/bin/goversioninfo -64 -icon=assets/genesisit.ico -application-icon=assets/genesisit.ico -manifest=assets/genesisit.exe.manifest \
	  ...
	  -file-version=1.0.0.0 -product-version=1.0.0.0 -product-name=RemoteIt \
      -internal-name=RemoteItAgent -original-name=RemoteIt-Agent-Setup.exe \
	  -ver-major=1 -ver-minor=0 -ver-patch=0 -ver-build=0 \
	  -product-ver-major=1 -product-ver-minor=0 -product-ver-patch=0 -product-ver-build=0 assets/versioninfo.json && \
