...
func desktopProfileForFPS(targetFPS int) desktopCaptureProfile {
	...
	case targetFPS <= 15:
		...
		return desktopCaptureProfile{maxWidth: 3840, quality: 94, fullChroma: true}
	case targetFPS >= 60:
		...
		return desktopCaptureProfile{maxWidth: 2560, quality: 88, fullChroma: true}
	default:
		...
		return desktopCaptureProfile{maxWidth: 3840, quality: 92, fullChroma: true}
	}
}
